...
class __TwigTemplate_840c3fb2da0eb7700ce216bf6233e9d8 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        // line 1
        echo "<div id=\"";
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, ($this->sandbox->ensureToStringAllowed(($context["field_id"] ?? null), 1, $this->source) . "_taxonomy_tree"), "html", null, true);
        echo "\" class=\"taxonomy-tree\">
